      ...
      <div className="w-full max-w-md">
        ...
        <motion.div key="login" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="bg-surface border border-border rounded-2xl p-8">
          ...
          <div className="space-y-3">
            <button onClick={() => handleSocial('google')} className="w-full flex items-center justify-center gap-3 bg-white text-gray-800 font-bold py-3.5 rounded-xl hover:bg-gray-100 transition-colors">
            ...
            <button onClick={() => handleSocial('kakao')} className="w-full flex items-center justify-center gap-3 bg-[#FEE500] text-[#191600] font-bold py-3.5 rounded-xl hover:bg-[#FADA0A] transition-colors">
          ...
          <p className="text-xs text-text-muted text-center mt-6 leading-relaxed">
            로그인하면 <span className="text-text-secondary underline">이용약관</span> 및 <span className="text-text-secondary underline">개인정보 처리방침</span>에 동의하는 것으로 간주합니다.
          </p>
        </motion.div>
      </div>
    </div>
